...
tape( 'the function has an arity of 1', function test( t ) {
	t.strictEqual( scuminabs.length, 1, 'has expected arity' );
	t.end();
});

tape( 'the function calculates the cumulative minimum absolute value of a one-dimensional ndarray', function test( t ) {
	var expected;
	var xbuf;
	var x;
	var y;
